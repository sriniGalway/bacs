...
connection = sqlite3.connect('AUDDIS_Rejection.db')
...
create_table_MessagingAdvice = "CREATE TABLE IF NOT EXISTS MessagingAdvice (user_number int PRIMARY KEY, record_type char, aosn int, processing_date date, originator_file_number text, work_code text, file_type text, accepted_ddi int, rejected_ddi int,vol_serial_number int, file_error_code int)"
...
VALUES
(100288,'R',506,'2017-04-05','001','1 DAILY','LIVE',0,2,465416,30410);"""
